				...
				<tbody>
					...
					?>  
						<tr>
							...
							<td class="text-left">2022-03-02</td>	
							<td class="text-left"><a class="dropdown-item" href="javascript:void(0)" data-id="">Initiate</a>							</td>				
							...
							<td align="center">
							<a class="dropdown-item action-data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Action</a>
							</td>
						</tr>
					<?php endwhile; ?>
				</tbody>
