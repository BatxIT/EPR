	...
	<form action="" id="client-form">
		...
		<div class="form-group">
			...
			<select name="status" id="status" class="form-control form-control-sm rounded-0" required="required">
				<option value="1" <?= isset($status) && $status == 1 ? 'selected' : '' ?>>OEM</option>
				<option value="2" <?= isset($status) && $status == 2 ? 'selected' : '' ?>>Services</option>
				<option value="3" <?= isset($status) && $status == 3 ? 'selected' : '' ?>>Producer</option>
			</select>
		</div>
		<div class="form-group">
			<label for="status" class="control-label">Account Type</label>
			<select name="status" id="status" class="form-control form-control-sm rounded-0" required="required">
				<option value="1" <?= isset($status) && $status == 1 ? 'selected' : '' ?>>Regular</option>
				<option value="2" <?= isset($status) && $status == 2 ? 'selected' : '' ?>>Temporary</option>
