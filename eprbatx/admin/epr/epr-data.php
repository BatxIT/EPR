...
{	 
	 ...
	 $sql = "INSERT INTO epr (qty,target,year,category)  VALUES ('$qty','$target','$year','$category')";
                    ...
                    <form action="" id="filter-form">
                        <div class="row align-items-end">
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                ...
                                <label for="description" class="control-label">Quantity</label>
                                <input type="text" name="qty" id="weight" class="form-control form-control-sm rounded-0" value="<?php echo isset($weight) ? $weight : ''; ?>"  required/>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="month" class="control-label">Collection Target Year</label>
                                    
                                <select name="year" id="year"  class="form-control form-control-sm rounded-0">                            
                                <option value="2015 - 16">2017 - 18</option>
                                <option value="2015 - 16">2018 - 19</option>
                                <option value="2015 - 16">2019 - 20</option>
                                <option value="2015 - 16">2020 - 21</option>
                                <option value="2015 - 16">2020 - 21</option>
                                <option value="2015 - 16">2021 - 22</option>
                                <option value="2015 - 16">2022 - 23</option>
                                </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                <label for="description" class="control-label">Sales Target</label>
                                
                                <select name="year" id="year"  class="form-control form-control-sm rounded-0">                          
                               
                                <option value="2015 - 16">2022 - 23</option>
                                <option value="2015 - 16">2023 - 24</option>
                                <option value="2015 - 16">2024 - 25</option>
                                <option value="2015 - 16">2025 - 26</option>
                                <option value="2015 - 16">2026 - 27</option>
                                <option value="2015 - 16">2027 - 28</option>
                                <option value="2015 - 16">2028 - 29</option>
                                <option value="2015 - 16">2029 - 30</option>
                                <option value="2015 - 16">2030 - 31</option>
                                </select>    
                            </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                ...
                                <input type="text" name="qty" id="weight" class="form-control form-control-sm rounded-0" value="<?php echo isset($category) ? $category : ''; ?>"  required/>
                            </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <button class="btn btn-sm btn-flat btn-primary"> Submit Data</button>
                                </div>
                            </div>
                        </div>
                    </form>
