...
if(isset($_POST['SubmitButton'])){ //check if form was submitted
  ...
  $message = "Target ".$input * 50 /100 ;
  $qty = "".$input;
}    
?>
<div class="content py-5 px-3 bg-gradient-teal">
    <h2>EPR Achive Target</h2>
</div>
                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="month" class="form-control form-control-sm rounded-0" name="inputText" id="inputText" value="<?= $month ?>" required="required">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                        ...
                        <table class="table table-bordered table-stripped table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="px-1 py-1 text-left"><?php echo $message; ?> 100</td>
                            ...
                            <tfoot>
                                <tr class="bg-gradient-secondary">
                                    <th class="py-1 text-center" colspan="5">EPR Report</th>
