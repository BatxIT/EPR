...
<div class="col-lg-12">
	<div class="card card-outline rounded-0 card-teal">
		<div class="card-header">
			<h5 class="card-title">Recycling Settings</h5>
    ...
    <div class="col">
			...
			<div class="form-group">
					<label for="name" class="control-label">Extraction Financial Year</label>
					<input type="text" class="form-control form-control-sm" name="name" id="name" value="<?php echo $_settings->info('fy') ?>">
			</div>
			
			
			<div class="form-group">
					<label for="short_name" class="control-label">Extract Target Value</label>
					<input type="text" class="form-control form-control-sm" name="short_name" id="short_name" value="" Placeholder="Target Value">
	...
	<div class="form-group">
					<label for="short_name" class="control-label">Extract Type</label>
					<select class="form-control form-control-sm" name="pets" id="pet-select">
					<option value="">Select Type </option>
					<option value="dog">Blackmass</option>
					<option value="cat">Other </option>					
				</select>
			</div>

			<div class="form-group">
			<label for="short_name" class="control-label">Procurement</label>
	...
	<label for="short_name" class="control-label">Battery Procurment Type</label>
    <div>
      <input type="checkbox" id="scales" name="scales" checked>
      <label for="scales">Refurbished</label>
    </div>

    <div>
      <input type="checkbox" id="horns" name="horns">
      <label for="horns">Recycled</label>
    </div>
