		...
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group">
                    ...
                    <option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected' : '' ?>>Batx User</option>
				...
				<div class="form-group">
					...
					<input type="text" name="mobile" id="mobile" class="form-control" value="<?php echo isset($meta['mobile']) ? $meta['mobile']: '' ?>" required  autocomplete="off">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
                    <label for="type" class="control-label">Department</label>
                    <select name="ac_type" id="ac_type" class="form-control form-control-sm rounded-0" required>
                    <option value="Manager" <?php echo isset($meta['ac_type']) && $meta['ac_type'] == 1 ? 'selected' : '' ?>>Manager</option>
                    <option value="Executive" <?php echo isset($meta['ac_type']) && $meta['ac_type'] == 2 ? 'selected' : '' ?>>Executive</option>
                    </select>
                </div>
				<div class="form-group">
					<label for="" class="control-label">Profile Pic</label>
